"""MCP server for Discord operations using MCPServer (MCP SDK v2)."""
...
def _tool(fn):
    """Register a tool, surfacing domain ValueError messages as deliberate errors."""
